...
mkdir -p ${UPDATE_DIR}
BASE_URI="https://raw.githubusercontent.com/bottkars/pks-jump-azure/testing/"
...
# wget -O - https://raw.githubusercontent.com/bottkars/pks-jump-azure/testing/scripts/update.sh | bash
